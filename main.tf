provider "aws"{
    region = "ap-south-1"
    profile = "Kay" // Replace it by your profile
...
variable "github_url"{
    type = string 
    default = "https://github.com/kanishkagarwal2000/SampleBasicSite.git" // Replace it by your GitHub Repo link
}
...
resource "aws_s3_bucket_object" "update_bucket"{
	...
	source = "SampleBasicSite/image.jpg" //Source of the file
	key = "image.jpg" // Name of the file to be saved as 
	acl = "public-read"
}
